...
public class GLFont {
	...
	/*
	 * 默认采用白色字体，宋体文字加粗Color.rgb(100, 0, 0)1F85FE
	 */
	public static Bitmap getImage(int width, int height, String mString, int size) {
		return getImage(width, height, mString, size, Color.rgb(31, 85, 254), Typeface.create("宋体", Typeface.NORMAL));
	}
	...
	public static Bitmap getImage(int width, int height, String mString, int size, int color, Typeface font) {
		...
		int y = height;
		Bitmap bmp = null;
		bmp = Bitmap.createBitmap(x, y, Bitmap.Config.ARGB_4444);
